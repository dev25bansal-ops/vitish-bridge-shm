...
| **SDNET2018** | Concrete crack / no-crack, **binary**, crack widths 0.06–25 mm | 56,000 × 256² · balanced | IEEE DataPort slug `sdnet2018-concrete-crack-image-dataset-machine-learning-applications` | Correct slug (report's URL 404'd). **No pixel masks** — classification/pretraining only |
