...
- **STATUS 2026-08-15 (ROADMAP line 98):** registration **NOT yet submitted**. The demo works from the MIT-licensed processed mirror (`thanglexuan/Z24-dataset-processed`) — see [[Z24-Benchmark]]; Q&A Q4 already states the honest position. **REMAINING HUMAN ACTION (one person, ~10 min):** submit the registration form at the link above, keep the confirmation email, drop the received .mat package into `data/z24/`, then update Q&A Q4 to say "registration complete, official .mat verified". Ready-to-send cover note if the form needs one:
  > *To the KU Leuven Structural Mechanics team — I am a member of a student team building a non-commercial bridge structural-health-monitoring research demo (academic hackathon). I would like to register to obtain the official Z24 bridge benchmark dataset for research use. I accept the non-commercial research terms and will cite KU Leuven Structural Mechanics in any public work, and will not transfer the data to third parties. Please let me know the next step. — [Name, institute, email]*
