...
# (parents[2] = D:\SHM_Bridges when invoked from pipelines/ltbp-priors/)
_path = Path(__file__).resolve()
ROOT = _path.parents[2] if (_path.name == "ltbp_analyze.py" and _path.parent.name == "ltbp-priors") else _path.parent.parent
DATA = ROOT / "data" / "ltbp"
OUT = DATA / "analysis"
