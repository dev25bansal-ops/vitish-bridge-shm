...
**Date:** 2026-08-16 · **Scope:** full project — build, data & training, hardware · **Commit reviewed:** `303f776` (posthack) + `c84fe35` (geo) on `main` · **Addendum (2026-08-16):** §117 follow-up — HBTA detection improvement levers + verified acoustic-emission data catalog (Category 8) · **Addendum (2026-08-17):** NOW items 1–6 landed + TEST-F3 (see §7.6), **30-day item 7 (S1 RUL decision surface) DONE** and **30-day item 8 (NEW-02 real site temperature) DONE** — gate count now **18**, all passing; the twin suite grew to 71 vitest
