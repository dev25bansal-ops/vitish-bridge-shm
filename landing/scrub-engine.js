/* ============================================================================
   ...
   VENDORED for VITISH item 20 (2026-08-18) from https://github.com/oso95/
   scroll-world (MIT © cyw 2026; see LICENSE-scroll-world.txt). Unmodified core
   except for this header. The landing page's films are rendered from the real
   Z24 bridge benchmark (scripts/render_z24_films.py) — see landing/assets/
   manifest.json for each clip's provenance.
